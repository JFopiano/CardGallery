...
class FollowersWidget extends StatefulWidget {
  ...
  final DocumentReference? userFollowers;
        ...
        body: Align(
          ...
          child: Container(
            ...
            child: StreamBuilder<UsersRecord>(
              stream: UsersRecord.getDocument(widget!.userFollowers!),
                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'FOLLOWERS_PAGE_arrow_back_ICN_ON_TAP');
                      ...
                      Padding(
                        ...
                        child: Builder(
                          builder: (context) {
                            final followers = columnUsersRecord.usersFollowingMe
                                .map((e) => e)
                                .toList();
                            ...
                            return ListView.builder(
                              ...
                              itemBuilder: (context, followersIndex) {
                                ...
                                return Padding(
                                  ...
                                  child: StreamBuilder<UsersRecord>(
                                    stream:
                                        UsersRecord.getDocument(followersItem),
                                    builder: (context, snapshot) {
                                      // Customize what your widget looks like when it's loading.
                                      if (!snapshot.hasData) {
                                        return Center(
                                      ...
                                      return InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'FOLLOWERS_PAGE_Container_xilihlk0_ON_TAP');
                                          logFirebaseEvent(
