                        ...
                        children: [
                                  ...
                                  return TextFormField(
                                    ...
                                    onChanged: (_) => EasyDebounce.debounce(
                                      ...
                                      () async {
                                        ...
                                        safeSetState(() {});
                                        logFirebaseEvent(
                                            'searchBar_google_analytics_event');
                                        logFirebaseEvent('pageSearch');
                                      },
                                    ),
                                    autofocus: false,
                                    obscureText: false,
                                    decoration: InputDecoration(
                                      isDense: true,
                                      labelText: 'Search for other users . . .',
                          ...
                          Padding(
                            ...
                            child: FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'SEARCH_PAGE_PAGE_cancel_sharp_ICN_ON_TAP');
                                logFirebaseEvent(
                              ...
                              Builder(
                                builder: (context) {
                                  ...
                                  return ListView.builder(
                                    ...
                                    itemCount: uservariable.length,
                                    itemBuilder: (context, uservariableIndex) {
                                      final uservariableItem =
                                          uservariable[uservariableIndex];
                                      return Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            16.0, 8.0, 16.0, 0.0),
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'SEARCH_Container_1yfr0bin_ON_TAP');
                                            logFirebaseEvent(
