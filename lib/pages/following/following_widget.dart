...
class FollowingWidget extends StatefulWidget {
  ...
  final DocumentReference? userFollowing;
        ...
        body: Align(
          ...
          child: Container(
            ...
            child: StreamBuilder<UsersRecord>(
              stream: UsersRecord.getDocument(widget!.userFollowing!),
                    ...
                    children: [
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'FOLLOWING_PAGE_arrow_back_ICN_ON_TAP');
                      ...
                      Padding(
                        ...
                        child: Builder(
                          builder: (context) {
                            final followering =
                                columnUsersRecord.followingUsers.toList();

                            return ListView.builder(
                              padding: EdgeInsets.zero,
                              shrinkWrap: true,
                              scrollDirection: Axis.vertical,
                              itemCount: followering.length,
                              itemBuilder: (context, followeringIndex) {
                                final followeringItem =
                                    followering[followeringIndex];
                                return Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      16.0, 8.0, 16.0, 0.0),
                                  child: StreamBuilder<UsersRecord>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      return InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'FOLLOWING_PAGE_Container_oq640xgo_ON_TAP');
                                          logFirebaseEvent(
