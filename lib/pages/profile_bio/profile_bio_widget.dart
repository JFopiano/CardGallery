...
import '/components/add_card_copy_widget.dart';
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () async {
            logFirebaseEvent('PROFILE_BIO_FloatingActionButton_7xc71wg');
                      ...
                      children: [
                        Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'PROFILE_BIO_PAGE_Icon_uek32j3x_ON_TAP');
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'PROFILE_BIO_PAGE_EditPreff_ON_TAP');
                              logFirebaseEvent('EditPreff_navigate_to');
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'PROFILE_BIO_PAGE_EDIT_PROFILE_BTN_ON_TAP');
                          ...
                          children: [
                            Align(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'PROFILE_BIO_PAGE_Image_ah1mrj2s_ON_TAP');
                            ...
                            Align(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'PROFILE_BIO_PAGE_Image_8jnbelgj_ON_TAP');
                            ...
                            Align(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'PROFILE_BIO_PAGE_Image_7h95cvz3_ON_TAP');
                                  logFirebaseEvent('Image_navigate_to');

                                  context.pushNamed('testGal');
                                },
                                child: ClipRRect(
                                  borderRadius: BorderRadius.circular(8.0),
                                  child: Image.network(
